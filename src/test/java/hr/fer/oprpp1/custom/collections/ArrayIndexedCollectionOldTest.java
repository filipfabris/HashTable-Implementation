...
class ArrayIndexedCollectionOldTest {

	ArrayIndexedCollection<Object> arrayTwoElements;
	ArrayIndexedCollection<Object> defaultArray;
	int sum;
	...
	void ArrayConstructorTest2() {
		ArrayIndexedCollection<Object> fromOther = new ArrayIndexedCollection<>(arrayTwoElements, 1);
	...
	void ArrayConstructorTest3() {
		assertThrows(IllegalArgumentException.class, () -> {
			new ArrayIndexedCollection<Object>(-1);
		});
	}
	...
	@Test
	void forEach() {
		ArrayIndexedCollection<Object> test = new ArrayIndexedCollection<Object>();
	...
	void equalsMethod() {
		...
		ArrayIndexedCollection<Object> array1 = new ArrayIndexedCollection<Object>();
		array1.add("ZZZ");
		array1.add(3);
		array1.add('h');

		ArrayIndexedCollection<Object> array2 = new ArrayIndexedCollection<Object>();
		array2.add("ZZZ");
